...
const wishlist = [
    {"_id":ObjectID("579f21de98689ebf2bf1cd2f"),"_class":"works.weave.socks.wishlist.entities.Wishlist","customerId":"579f21ae98684924944651bf","items":[{"$ref":"item","$id":ObjectID("579f227698689ebf2bf1cd31")},{"$ref":"item","$id":ObjectID("579f22ac98689ebf2bf1cd32")}]},
    {"_id":ObjectID("579f21e298689ebf2bf1cd30"),"_class":"works.weave.socks.wishlist.entities.Wishlist","customerId":"579f21ae98684924944651bfaa","items":[]}
];


const item = [
    {"_id":ObjectID("579f227698689ebf2bf1cd31"),"_class":"works.weave.socks.wishlist.entities.Item","itemId":"819e1fbf-8b7e-4f6d-811f-693534916a8b","quantity":20,"unitPrice":99.0}
];
...
hooks.beforeEach((transaction, done) => {
	...
	var promisesToKeep = [
	    ...
	    db.collection('wishlist').insertMany(wishlist),
...
hooks.before("/wishlists/{customerId}/items > POST", function(transaction, done) {
...
hooks.before("/wishlists/{customerId}/items > PATCH", function(transaction, done) {
    transaction.skip = true;
    done();
});
